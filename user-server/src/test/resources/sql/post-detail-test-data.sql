...
-- 최신순(DESC): 첫 페이지 id 25~6, 다음 페이지 id 5~1
-- id=25: 대댓글 있음 (트리 테스트용)
-- id=24: 삭제된 댓글 + 대댓글 있음 (삭제 댓글 테스트용)
-- id=15: 차단유저 댓글 (필터 테스트용)
INSERT INTO comment (id, post_id, user_id, parent_id, content, depth, like_count, status, created_at, updated_at) VALUES
(1, 100, 2, NULL, '댓글 1', 0, 0, 'ACTIVE', '2025-01-01 00:00:01', NOW()),
...
(5, 100, 2, NULL, '댓글 5', 0, 0, 'ACTIVE', '2025-01-01 00:00:05', NOW()),
...
(10, 100, 2, NULL, '댓글 10', 0, 0, 'ACTIVE', '2025-01-01 00:00:10', NOW()),
...
(15, 100, 3, NULL, '차단유저 댓글', 0, 0, 'ACTIVE', '2025-01-01 00:00:15', NOW()),
...
(24, 100, 2, NULL, '삭제된 댓글 (답글 있음)', 0, 0, 'DELETED', '2025-01-01 00:00:24', NOW()),
(25, 100, 1, NULL, '댓글 25 (대댓글 있음)', 0, 5, 'ACTIVE', '2025-01-01 00:00:25', NOW());

-- 대댓글 (depth=1)
-- 댓글 25에 대한 대댓글 2개 (첫 페이지에서 트리 테스트용)
INSERT INTO comment (id, post_id, user_id, parent_id, content, depth, like_count, status, created_at, updated_at) VALUES
(101, 100, 2, 25, '댓글 25에 대한 답글 1', 1, 0, 'ACTIVE', '2025-01-01 00:01:01', NOW()),
(102, 100, 2, 25, '댓글 25에 대한 답글 2', 1, 2, 'ACTIVE', '2025-01-01 00:01:02', NOW());

-- 삭제된 댓글(24)에 대한 활성 대댓글 (삭제된 댓글입니다로 표시되어야 함)
INSERT INTO comment (id, post_id, user_id, parent_id, content, depth, like_count, status, created_at, updated_at) VALUES
(103, 100, 2, 24, '삭제된 댓글의 답글', 1, 0, 'ACTIVE', '2025-01-01 00:01:03', NOW());

-- 차단유저 댓글(15)에 대한 대댓글 (부모가 제외되어야 함)
INSERT INTO comment (id, post_id, user_id, parent_id, content, depth, like_count, status, created_at, updated_at) VALUES
(104, 100, 2, 15, '차단유저 댓글의 답글', 1, 0, 'ACTIVE', '2025-01-01 00:01:04', NOW());

-- 댓글 좋아요 (user 1이 댓글 25, 102에 좋아요)
