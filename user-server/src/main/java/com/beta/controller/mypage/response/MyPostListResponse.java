package com.beta.controller.mypage.response;
...
public class MyPostListResponse {
    ...
    public static MyPostListResponse from(MyPostListDto dto) {
        List<MyPostSummary> posts = dto.getPosts().stream()
                .map(MyPostSummary::from)
                .toList();
    ...
    public static class MyPostSummary {
        ...
        public static MyPostSummary from(MyPostListDto.MyPostDto dto) {
